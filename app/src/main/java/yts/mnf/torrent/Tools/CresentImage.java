...
public class CresentImage  extends android.support.v7.widget.AppCompatImageView {
    ...
    public CresentImage(Context context) {
        super(context);
        init(context, null);
    }

    public CresentImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (getDrawable() != null) {
            ...
            if (getBackground() != null) {
                Log.e("cresent image","has background");
